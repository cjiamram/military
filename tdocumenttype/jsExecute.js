...
function displayData(){
		var url="tdocumenttype/displayData.php?tableName=t_documenttype&dbName=dbsodier&keyWord="+$("#txtSearch").val();
		$("#tblDisplay").load(url);
}
function createData(){
		var url='tdocumenttype/create.php';
		jsonObj={
			code:$("#obj_code").val(),
...
function updateData(){
		var url='tdocumenttype/update.php';
		jsonObj={
			code:$("#obj_code").val(),
			description:$("#obj_description").val(),
			id:$("#obj_id").val()
...
function readOne(id){
		var url='tdocumenttype/readOne.php?id='+id;
		data=queryData(url);
		if(data!=""){
...
function confirmDelete(id){
		...
		if (willDelete.value) {
			url="tdocumenttype/delete.php?id="+id;
