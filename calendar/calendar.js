...
function showCalendar(id) {
	...
	if (calendar != null) {
		...
		cal.setRange(1950, 2090);	// min/max year allowed
...
Date.prototype.print = function (frm) {
	...
	var re = /(.*)(\W|^)(d|dd|m|mm|y|yy|yt|MM|M|DD|D|w|ww)(\W|$)(.*)/;
...
Calendar._TT["PART_TODAY"] = "(Part to Day)";
Calendar._TT["MON_FIRST"] = "Month First";
Calendar._TT["SUN_FIRST"] = "Sun First";
Calendar._TT["CLOSE"] = "Close";
Calendar._TT["TODAY"] = "Today";

// ¡ÒÃ¨Ñ´ÃÙ»áºº¤èÒ»¯Ô·Ô¹
Calendar._TT["DEF_DATE_FORMAT"] = "dd/mm/yt"; // ¡Ã³ÕµéÍ§¡ÒÃãËéà»ç¹»Õ ¤.È. ãËéä»Åº "+ 543" ·ÕèºÃÃ·Ñ´ 332,979 ÍÍ¡´éÇÂ¤ÃÑº (ÊèÇ¹ºÃÃ·Ñ´¹Õéà»ÅÕèÂ¹¤ÓÇèÒ yt à»ç¹ yy à·èÒ¹Ñé¹¡ç¾Í)
Calendar._TT["TT_DATE_FORMAT"] = "D, d M"; // ÃÙ»áºº¡ÒÃ¨Ñ´àÃÕÂ§ÇÑ¹·Õè ·Õè¨ÐáÊ´§ àÁ×èÍ¹Ó Mouse ä»ªÕé
