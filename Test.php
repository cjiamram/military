...
<head>
  ...
  <title>Sodier Registration</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="#" class="logo">
      <span class="logo-mini"><b>SREG</b></span>
      <span class="logo-lg"><b>Sodier Register</b></span>
    </a>
...
(async () => {
  ...
  function initialize(){
    ...
    $("#dvMain").load("<?=$rootPath?>/tregister/TUpload.php");
  }
