...
<div class="box-header with-border">
  <h3 class="box-title">Create Index List
  </h3>
</div>
 <div class="box-body">
...
<script>
	...
	function buildModel(dbName,tbName){
		var url="buildModel/buildIndex.php?dbName="+dbName+"&tableName="+tbName;
		var data=executeGet(url);

		if(data.message==true){
			var flagJs=buildJsExecute(dbName,tbName);
			if(flagJs==true){
				swal.fire({
                    title: "Build View",
                    text: "Create View Complete",
                    type: "success",
                    button: false
                });
			}else{
	...
	function buildJsExecute(dbName,tbName){
